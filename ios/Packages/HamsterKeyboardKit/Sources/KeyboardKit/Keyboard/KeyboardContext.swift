...
//      self.hamsterConfiguration = try ZippyJSONDecoder().decode(HamsterConfiguration.self, from: data)
  ...
  var classifySymbolKeyboardLockState: Bool {
    get {
      UserDefaults.standard.bool(forKey: "com.XiangqingZHANG.nanomouse.keyboard.classifySymbolKeyboard.lockState")
    }
    set {
      UserDefaults.standard.set(newValue, forKey: "com.XiangqingZHANG.nanomouse.keyboard.classifySymbolKeyboard.lockState")
    }
  }
