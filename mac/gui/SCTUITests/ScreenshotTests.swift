...
final class ScreenshotTests: XCTestCase {
    ...
    private let scenarios: [Scenario] = [
        Scenario(outputName: "01_byte_paste", id: "bytePaste", readyIdentifier: "screenshot_ready_bytePaste"),
        Scenario(outputName: "02_byte_paste_editor", id: "bytePasteEditor", readyIdentifier: "screenshot_ready_bytePasteEditor"),
